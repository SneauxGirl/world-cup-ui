...
/** Full-color Octocat from `public/github-octocat-svgrepo-com.svg` — fills are fixed; not themeable. */
export type GitHubOctocatIconProps = {
  width?: number;
  height?: number;
};

export function GitHubOctocatIcon({
  width = 40,
  height = 40,
}: GitHubOctocatIconProps) {
  const uid = useId().replace(/:/g, "");
  const pathDefId = `wcui-octocat-def-${uid}`;
  const clipPathId = `wcui-octocat-clip-${uid}`;

  const tentacleBaseD =
    "M200.9,199.8c0,13.9-32.2,25.1-71.9,25.1c-39.7,0-71.9-11.3-71.9-25.1c0-13.9,32.2-25.1,71.9-25.1C168.7,174.7,200.9,185.9,200.9,199.8L200.9,199.8z M200.9,199.8";
  const clipMaskD =
    "M98.1,244.8c1.6,7.5,5.5,11.9,9.4,14.5l41.1,0c5-3.4,10.1-9.8,10.1-21.8v-31c0,0,0.6-7.7,7.7-10.2c0,0,4.1-2.9-0.3-4.5c0,0-19.5-1.6-19.5,14.4v23.6c0,0,0.8,8.7-3.8,12.3v-29.2c0,0,0.3-9.3,5.1-12.8c0,0,3.2-5.7-3.8-4.2c0,0-13.4,1.9-14,17.6l-0.3,30h-3.2l-0.3-30c-0.6-15.6-14-17.6-14-17.6c-7-1.6-3.8,4.2-3.8,4.2c4.8,3.5,5.1,12.8,5.1,12.8v29.5c-4.6-3.3-3.8-12.6-3.8-12.6v-23.6c0-16-19.5-14.4-19.5-14.4c-4.5,1.6-0.3,4.5-0.3,4.5c7,2.6,7.7,10.2,7.7,10.2v21.7L98.1,244.8z";
  ...
  return (
    ...
    >
      <g>
        <path fill="#9EDCF2" d={tentacleBaseD} />
        <defs>
          <path id={pathDefId} d={clipMaskD} />
          <clipPath id={clipPathId}>
            <use href={`#${pathDefId}`} />
          </clipPath>
        </defs>
        <path clipPath={`url(#${clipPathId})`} fill="#7DBCE7" d={tentacleBaseD} />
        <path
          fill="#9EDCF2"
